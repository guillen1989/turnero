...
> Historial completo de pasos y fases anteriores, movido aquí desde `PROGRESS.md` el 2026-07-25 para mantener ese archivo ligero (ver `CLAUDE.md`).
> Este archivo **no se lee automáticamente al reanudar sesión** — solo se consulta bajo demanda (p. ej. "¿cómo se resolvió X hace tiempo?"). Para el historial detallado commit a commit, `git log` es la fuente autoritativa.
...
## Fase 12 — Hojas de cambio para "cambios a 3" (cadena_3)
Plan completo en `docs/PLAN_3.md`. Fase cerrada; detalle paso a paso:
