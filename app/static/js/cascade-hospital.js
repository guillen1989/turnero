 ...
 *
 * Se inicializa una cascada por prefijo de IDs: '' (registro/perfil) y
 * 'extra-' (bloque "añadir otro servicio" del registro), si existe.
 */
(function () {
  function inicializarCascada(prefix) {
      var NUEVA = '0';
