...
TIPOS_NOTIFICACION = ("nuevo_match", "confirmacion_parcial", "desconfirmacion", "rechazo", "caducidad", "nueva_publicacion_seguido", "contraoferta", "alerta_busqueda_guardada", "aviso_oportunidad_3", "contrasena_restablecida")
