...
TIPOS_NOTIFICACION = ("nuevo_match", "confirmacion_parcial", "desconfirmacion", "rechazo", "caducidad", "nueva_publicacion_seguido", "contraoferta", "alerta_busqueda_guardada", "aviso_oportunidad_3", "aviso_oportunidad_4", "contrasena_restablecida", "documento_cambio_pendiente_firma", "documento_cambio_completo", "documento_cambio_autorizado", "documento_cambio_denegado")
